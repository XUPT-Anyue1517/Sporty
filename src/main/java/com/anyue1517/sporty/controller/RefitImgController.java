...
@RestController
@RequestMapping("/refits")
@Slf4j
public class RefitImgController {
...
//        System.out.println("!!!!name:" + originalFilename);
        ...
        String rootFilePath = System.getProperty("user.dir") + "/src/main/resources/refits/" + flag + "$&$&" + originalFilename;
        //获取上传的路径
        ...
        return Result.success("http://localhost"+ ":" +  "8080/refits/" + originalFilename);  // 返回结果 url
...
//        }
        ...
        String basePath = System.getProperty("user.dir") + "/src/main/resources/refits/";  // 定于文件上传的根路径
