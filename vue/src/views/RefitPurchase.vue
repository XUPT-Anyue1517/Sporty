<template>
  ...
  <el-row class="row-bg" justify="center" gutter="20">
    <el-col :span="10">
      <el-image :src=purchaseLeft_img :fit="cover" style="width:640px;height:640px"> </el-image>
      <h1 style="text-align:center"></h1>
    </el-col>
    <el-col :span="9">
      <div class="purchaseRight">
        <span class="title-text">{{ refitName }}</span>
        <br>
        <div class="text-info">
...
export default {
  ...
  methods:{
    ...
    load(){
      this.refitName = this.$route.query.name
      request.get("/refit",{
        params:{
          pageNum:'1',
          pageSize:'5',
        ...
        this.carPrice = res.data.records[0].salePrice

        this.onePrice = res.data.records[0].salePrice
        this.price = res.data.records[0].salePrice
